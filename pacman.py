...
def readCommand(argv):
    ...
    parser.add_option('--replay', dest='gameToReplay',
                      help='A recorded_final game file (pickle) to replay', default=None)
    ...
    # Special case: recorded_final games don't use the runGames method or args structure
...
def runGames(layout, pacman, ghosts, display, numGames, record, numTraining=0, catchExceptions=False, timeout=30):
    ...
    for i in range(numGames):
        ...
        if (record is True) and (i % 200 == 0):
            import time
            import pickle
            fname = ('./recorded_initial/recorded_final-game-%d' % (i + 1)) + \
